...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.clone_number = 0
        self.ostart = Point(start.x, start.y)
        self.oend = Point(end.x, end.y)
        # --------------------------------------------------------------
        # Done: 3.
    ...
    def length(self):
        ...
        Type hints:
          :rtype: float
        """
        answer = self.start.distance_from(self.end)
        return answer
        # --------------------------------------------------------------
        # Done: 7.
        #   a. READ the above specification, including the Example.
    ...
    def is_parallel(self, line2):
        ...
        if self.slope() == math.inf:
            ...
            slope1 = round(self.slope(), 9)
        if line2.slope() == math.inf:
            slope2 = math.inf
        else:
            slope2 = round(line2.slope(), 9)
        if abs(slope1 - slope2) <= 0.000000001:
            return True
        elif slope1 == slope2 == math.inf:
            return True
        else:
            return False
        # --------------------------------------------------------------
